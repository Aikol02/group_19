class Transport:
    def __init__(self, year_value, model, color):
        self.year_value = year_value  # self.year - attribute, year_value - parameter
        self.model = model
        self.color = color
...
print(f'Model: {mazda_car.model} Year: {mazda_car.year_value} Color: {mazda_car.color} '
...
print(f'Model: {bmw_car.model} Year: {bmw_car.year_value} Color: {bmw_car.color} '
...
print(f'Model: {audi_car.model} Year: {audi_car.year_value} Color: {audi_car.color} '
      f'Penalties of car: {audi_car.penalties} Number of wheels: {audi_car.number_of_wheels}')

print(f'We need {Car.number_of_wheels * Car.counter} winter lastics')

airbus_plane = Plane(2022, "A-360", "White")
print(f'PLANE Model: {airbus_plane.model} Year: {airbus_plane.year_value} Color: {airbus_plane.color}')
airbus_plane.change_color("Blue")
print(f'PLANE Model: {airbus_plane.model} Year: {airbus_plane.year_value} Color: {airbus_plane.color}')

volvo_truck = Truck(2000, "Volvo - 8788", "Blue", 20000)
print(f'TRUCK Model: {volvo_truck.model} Year: {volvo_truck.year_value} Color: {volvo_truck.color} '
